...
//
//        given(client.listContacts(1)).willReturn(contacts);
//
...
//        given(client.listContacts(1)).willThrow(new NotFoundException("Contacts not found or user with this id:" + 1 + " not found"));
//
//        mockMvc.perform(get("/users/{userId}/contacts", 1)
//                .contentType(MediaType.APPLICATION_JSON))
...
//        given(client.findContactById(1, 1)).willReturn(contactDTO);
//
...
//        given(client.findContactById(1, 1)).willThrow(new NotFoundException("User with id:" + 1 + " not found" + " or " + "Contact with id:" + 1 + " not found"));
//
//        mockMvc.perform(get("/users/{userId}/contacts/{contactId}", 1, 1)
//                .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isNotFound())
...
//        List<ContactDTO> contacts = Collections.singletonList(contactDTO);
//
//        given(client.findContactsByPhone("1234567890", 1)).willReturn(contacts);
//
...
//        given(client.findContactsByPhone("9876543210", 1))
...
//        given(client.createContact(1, contact)).willReturn(contactDTO);
//
...
//
//        given(client.putContact(1, 1, changedContact)).willReturn(changedContactDto);
//
...
//        doThrow(new NotFoundException("User with id:" + 1 + " not found" + " or " + "Contact with id:" + 1 + " not found")).when(client).deleteContact(1, 1);
//
//        mockMvc.perform(delete("/users/{userId}/contacts/{contactId}", 1, 1)
//                .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isNotFound())
