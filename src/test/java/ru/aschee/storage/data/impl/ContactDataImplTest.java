...
//public class ContactDataImplTest {
//
//    @Autowired
//    private ContactDataImpl contactService;
//
//    @MockBean
...
//
//        ContactDTO contactDTO = contactService.createContact(user1.getId(), contact1);
//
...
//        contact1.setUser(null);
//        when(contactRepository.save(contact1)).thenReturn(contact1);
//        contactService.createContact(1, contact1);
//    }
//
//    @Test
...
//
//        List<ContactDTO> contactDTOList = contactService.listContacts(user.getId());
//
...
//
//        List<ContactDTO> contactDTOS = contactService.findContactsByPhone("1234567890", user.getId());
//
...
//        when(userRepository.existsById(1)).thenReturn(true);
//
//        ContactDTO contactDTO = contactService.findContactById(1, 1);
//
//        assertThat(contactDTO.getId(), is(contact1.getId()));
//        assertThat(contactDTO.getFirstName(), is(contact1.getFirstName()));
//        assertThat(contactDTO.getLastName(), is(contact1.getLastName()));
...
//
//        contactService.findContactById(1, 1);
//    }
//
//    @Test(expected = NotFoundException.class)
...
//        when(contactRepository.save(contact1)).thenReturn(contact1);
//
//        ContactDTO contactDTO = contactService.putContact(1, 1, contact2);
//
...
//
//        contactService.putContact(1, 1, contact2);
//    }
//
//    @Test(expected = NotFoundException.class)
